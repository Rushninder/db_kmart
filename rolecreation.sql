...
--logins
CREATE LOGIN BenTen WITH PASSWORD = '0396742',DEFAULT_DATABASE = KMart,CHECK_POLICY =OFF;
CREATE LOGIN AliceJohnson WITH PASSWORD = '0396742',DEFAULT_DATABASE = KMart,CHECK_POLICY =OFF;
CREATE LOGIN BobWilliams WITH PASSWORD = '0396742',DEFAULT_DATABASE =  KMart,CHECK_POLICY =OFF;
